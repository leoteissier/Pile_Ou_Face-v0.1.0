...
function annotateEntriesWithDiagnostics(entries, diagnostics = []) {
  ...
  return (Array.isArray(entries) ? entries : []).map((entry) => {
    ...
    const isCorrupted = primary.kind === 'return_address_corrupted'
      ...
      || (primary.kind === 'invalid_control_flow' && primarySlotKind === 'return_address');
...
function diagnosticMatchesEntry(diagnostic, entry) {
...
function upsertDiagnosticRow(rows, label, value) {
